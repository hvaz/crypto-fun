...
class Exchange(object):
    ...
    def __format_candles(self, candles):
        ...
        formatted_candles = [{param: c[index] if index != None else param: None 
        ...
        with open(filename, 'a') as f:
            ...
            with requests.Session() as session:
                ...
                while (candles_count < target):
                    ...
                    payload = {'symbol': mkt_name, 'interval': interval, 'limit': 2}
    ...
    def update_candles(self, mkt_name, size, unit):
        ...
        interval = self.get_interval(size, unit)
